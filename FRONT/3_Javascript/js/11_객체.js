...
document.getElementById("btn1").addEventListener("click", function() {
    ...
    // ** (중요) **
    // 자바스크립트 객체의 Key는 무조건 String(묵시적)이다.
    // "Key" 또는 'Key' 또는 Key (따옴표 없어도 String으로 인식한다.)
...
document.getElementById("btn2").addEventListener("click", function() {
    ...
    const std2 = new Student("윤주빈", 2, 6);
    const std3 = new Student("윤성시", 1, 4);
