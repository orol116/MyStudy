...
public class EmployeeView {
    ...
    public void selectOne() {
        ...
        // printList() 메서드 호출 시 매개변수로 전달하기 위한 List 생성
    ...
    /**
     * 입력 급여 이상으로 받는 사원 정보 조회 View
     */
    public void selectSalary() {
        System.out.println("[입력 받은 급여 이상으로 받는 사원 정보 조회]");
        ...
        printList(empList);
        System.out.println("총 인원 : " + empList.size());
    ...
    public void updateEmployee2() {
        ...
        int result = service.updateEmployee2(emp);
    ...
    /**
     * 부서코드, 보너스율을 입력 받아 해당 부서의 보너스를 모두 수정 View
     */
