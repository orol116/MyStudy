-- [관리자 계정] member 계정 생성
CREATE USER yjb_member IDENTIFIED BY member1234;

-- [관리자 계정] CONNECT, RESOURCE + CREATE VIEW 권한 부여 + 객체 생성 공간 할당
GRANT CONNECT, RESOURCE, CREATE VIEW TO yjb_member;
ALTER USER yjb_member DEFAULT TABLESPACE SYSTEM QUOTA UNLIMITED ON SYSTEM;

-- yjb_member 계정 접속 방법 추가
