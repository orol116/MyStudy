...
public class PolyService {
    ...
    // 매개변수에 부모 타입 참조변수를 작성하여 모든 자식 객체를 전달 받을 수 있다.
    public void printCar(Car temp) {
        // 매개변수에 작성된 참조형 변수에는 주소가 얕은 복사 된다.
    ...
    public void ex3() {
        ...
        // - 다운 캐스팅이란?
        // --> 부모 타입 참조 변수가 자식 객체를 참조하는 업 캐스팅 상태에서만 진행 가능
    ...
    public void ex4() {
        ...
        //    Spark 참조변수로 Tesla를 참조하려고해서 문제 발생
    ...
    public void ex5() {
        ...
        // -> 실행 시에는 자식(Spark)의 오버라이딩된 메서드와 바인딩
        // --->> [동적 바인딩]

        // ** 동적 바인딩 활용 방법 **
        Car[] arr = {new Car("경유 엔젠", "경유", 12),
                     new Tesla("전기 모터", "전기", 4, 50000),
                     new Spark("경차 엔진", "무연", 4, 0.3)
                    };

        // arr 배열요소가 참조하는 모든 갹채의 필드 값을 출력
        for (int i = 0; i < arr.length; i++)
