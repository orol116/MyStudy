...
public class ExceptionService {
    ...
    public void ex1() {
        ...
        try {
            ...
            sc.nextLine(); // 버퍼에 남아있는 잘못 입력된 물자열을 제거
        }
    ...
    public void ex3() {
        ...
        try {
            ...
            // 관계없는 예외는 순서관계없이 catch문에 작성하면 된다.
            ...
            // 다형성 - 업캐스팅 : 부모 타입 참조 변수로

            // ** 상위 타입의 예외 클래스를 catch문에 작성하면
            //    다형성 업캐스팅에 의해 모두 잡아서 처리함 **
    ...
    public void ex5() {
        ...
        // throw  : 예외를 강제로 발생시키는 구문(현재 메서드에 예외를 던짐)

        try {
            methodA();
        } catch (Exception e) {
            // Exception : 모든 예외의 최상위 부모
            // -> catch 매개변수로 작성되었다 == 예외 종류 상관없이 모두 처리
    ...
    public void methodD() {
        ...
        // <CheckedException>
        // - RuntimeException과 자식 예외를 제외한 나머지를 지칭
