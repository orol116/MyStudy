...
public class MemberService { // 클래스
    ...
    public String login() {
        ...
        if (memberInfo == null) return "회원 가입부터 진행해주세요.";
    ...
    public String selectMember() {
        ...
        if (loginMember == null) {
            ...
            // return 구문이 수행되면 해당 메서드는 즉시 종료되고
            // 호출한 곳으로 돌아감
        }
    ...
    // 회원 정보 수정 기능(update, modify, alter.. 기능)
