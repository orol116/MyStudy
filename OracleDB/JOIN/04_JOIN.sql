...
-- DEPARTMENT 테이블의 국내영업부, 마케팅부, 해외여행3부 모두 결과에 포함
...
AND LOCATION+ID = LOCAL_CODE; -- (EMPLOYEE + DEPARTMENT) JOIN LOCATION
...
--연봉에 보너스포인트를 적용하시오.
SELECT EMP_NAME, JOB_NAME, SALARY, ((SALARY * 12) + ((SALARY * 12) * NVL(BONUS, 0))) 연봉
FROM EMPLOYEE
